...
class TestDataCollection(unittest.TestCase):
    ...
    @patch('cassandra_dev_news_agent.src.data_collection.changes_scraper.requests.get')
    ...
    @patch('cassandra_dev_news_agent.src.data_collection.jira_scraper.JIRA')
    ...
    @patch('cassandra_dev_news_agent.src.data_collection.cep_scraper.requests.get')
    ...
    @patch('cassandra_dev_news_agent.src.data_collection.mailing_list_scraper.requests.get')
